...
func NewDaemonSetHandler(Client client.Client, Scheme *runtime.Scheme) operands.Operand {
	return operands.NewConditionalHandler(
		operands.NewDaemonSetHandler(Client, Scheme, newWaspAgent),
...
func newWaspAgent(hc *hcov1beta1.HyperConverged) *appsv1.DaemonSet {
